          ...
          <div className="parent-group" style={{ maxWidth: "800px", margin: "0 auto", width: "100%" }}>
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-around", gap: "40px" }}>
              ...
              <div style={{ flex: "1 1 300px", textAlign: "center" }}>
                ...
                <p style={{ margin: "5px 0", fontSize: "1.1rem", color: "var(--text-color)" }}><strong>Mr.V. Ravichandran<br />&<br />Mrs. Thangam</strong></p>
              ...
              <div style={{ flex: "1 1 300px", textAlign: "center" }}>
                ...
                <p style={{ margin: "5px 0", fontSize: "1.1rem", color: "var(--text-color)" }}><strong>Mr.B. Natarajan<br />&<br />Mrs. Selvi</strong></p>
